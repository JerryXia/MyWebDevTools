...
'</div>'
    ...
    function renderVmData(){
        ...
        var vuejs = document.createElement('script'); vuejs.type = 'text/javascript'; vuejs.src = docProto + '//cdn.guqiankun.com/js/mts/vue.a6f91fa8bed3851638e09086b0e3d646.js'; document.getElementsByTagName('body')[0].appendChild(vuejs);
    };
    // 第五步：渲染数据
    renderVmData();
