...
'</div>'
    ...
    function renderVmData(){
        ...
        var vuejs = document.createElement('script'); vuejs.type = 'text/javascript'; vuejs.src = docProto + '//cdn.guqiankun.com/js/mts/vue.0b1c8644cc40fc949d5325ac9128ee30.js'; document.getElementsByTagName('body')[0].appendChild(vuejs);
    };
    // 第五步：渲染数据
    renderVmData();
