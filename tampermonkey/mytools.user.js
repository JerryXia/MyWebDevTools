...
'</div>'
    ...
    function renderVmData(){
        ...
        var vuejs = document.createElement('script'); vuejs.type = 'text/javascript'; vuejs.src = docProto + '//cdn.guqiankun.com/js/mts/vue.74bdacb483a2950c9a837f3c7e3831b6.js'; document.getElementsByTagName('body')[0].appendChild(vuejs);
    };
    // 第五步：渲染数据
    renderVmData();
