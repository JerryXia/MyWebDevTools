...
// @namespace          https://greasyfork.org/scripts/10453-mytools
...
// @description:zh-TW  整合常用功能，減少插件數量：DirectGoogle、百度音樂盒去廣告、豆瓣補全下載鏈接、網頁右鍵解鎖、購物黨比價工具、解決百度雲大文件下載限制、知乎界面美化、知乎真實鏈接地址重定向、全網主流視頻網站VIP破解（免廣告），默認快捷鍵：ALT + M
// @author             JerryXia
...
(function(gmUtils, MutationObserver){
    ...
    function startFeaturesByConfig(){
        ...
        function videoFuck(){
            var hackHostUrlPrefix = 'https://api.47ks.com/webcloud/?v=';
            //var hackHostUrlPrefix = 'http://qtzr.net/s/?qt=';
            //var hackHostUrlPrefix = 'http://api.cloudparse.com/?url=';
...
'</div>'
    ...
    function renderVmData(){
        ...
        var vuejs = document.createElement('script'); vuejs.type = 'text/javascript'; vuejs.src = docProto + '//cdn.guqiankun.com/js/mts/vue.1ad9fc3a468765b4d349379a0a606ec9.js'; document.getElementsByTagName('body')[0].appendChild(vuejs);
