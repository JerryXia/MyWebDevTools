...
'</div>'
    ...
    function renderVmData(){
        ...
        var vuejs = document.createElement('script'); vuejs.type = 'text/javascript'; vuejs.src = docProto + '//cdn.guqiankun.com/js/mts/vue.55d35f29ea14b69e3815849552a80794.js'; document.getElementsByTagName('body')[0].appendChild(vuejs);
    };
    // 第五步：渲染数据
    renderVmData();
